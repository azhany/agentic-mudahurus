...
const messages = {
  ms: {
    nav: { dashboard: 'Papan Pemuka', products: 'Produk', categories: 'Kategori', orders: 'Pesanan', customers: 'Pelanggan', coupons: 'Kupon', logout: 'Log Keluar' },
  ...
  en: {
    nav: { dashboard: 'Dashboard', products: 'Products', categories: 'Categories', orders: 'Orders', customers: 'Customers', coupons: 'Coupons', logout: 'Log out' },
